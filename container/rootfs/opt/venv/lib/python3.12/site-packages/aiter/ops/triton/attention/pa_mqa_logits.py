...
def deepgemm_fp8_paged_mqa_logits_ragged_k(
    ...
    # vllm-strix-halo: the packed cache holds NVIDIA-style fp8 (fp8e4nv)
    # bytes, but triton's tl.dot on AMD only accepts the ROCm-native
    # fp8e4m3fnuz. Reinterpret the payload and convert the values.
    kv_cache_fp8 = (
